...
var iconv = require('iconv-lite');//byliang
...
exports.env = exports.jsdom.env = function () {
  ...
  function handleUrl() {
    var options = {
      uri: config.url,
      encoding : (typeof(config.encoding) === "undefined") ? 'utf8' : config.encoding,  //by liang
    ...
    request(options, function (err, res, responseText) {
      ...
      //BYLIANG 
      if(config.decoding == 'GBK'){
         config.html = iconv.decode(config.html, 'GBK');
      }
